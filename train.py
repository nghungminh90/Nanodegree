...
def train_model(image_datasets, arch='vgg16', hidden_units=4096, epochs=5, learning_rate=0.001, gpu=False, checkpoint=''):
    ...
    dataloaders = {
        x: data.DataLoader(image_datasets[x], batch_size=64, shuffle=True, num_workers=2)
